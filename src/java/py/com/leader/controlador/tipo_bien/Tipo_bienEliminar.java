 ...
 * @author Esteban
 */
@WebServlet(name = "Tipo_bienEliminar", urlPatterns = {"/tipo_bien/eliminar"})
public class Tipo_bienEliminar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_tipo_bien")) {
                    ...
                    correcto = tipo_bienDAO.eliminar(Integer.parseInt(request.getParameter("id_tipo_bien")));
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
