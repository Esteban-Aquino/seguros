...
import py.com.leader.controlador.vendedor.*;
 ...
 * @author Esteban
 */
@WebServlet(name = "VendedorEliminar", urlPatterns = {"/vendedor/eliminar"})
public class VendedorEliminar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_vendedor")) {
                    ...
                    correcto = vendedorDAO.eliminar(Integer.parseInt(request.getParameter("id_vendedor")));
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
