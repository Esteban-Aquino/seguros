 ...
 * @author Esteban
 */
@WebServlet(name = "CobradorGuardar", urlPatterns = {"/cobrador/guardar"})
public class CobradorGuardar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            if (usuario == null) {
                ...
                if ("0".equals(request.getParameter("id_persona"))) {
                    ...
                    cobrador.setNombre_cobrador(request.getParameter("nombre_persona"));
                    ...
                    correcto = cobradorDAO.guardar(cobrador, new Usuario());
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
