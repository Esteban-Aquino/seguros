 ...
 * @author Esteban
 */
@WebServlet(name = "PolizaBuscarNombre", urlPatterns = {"/poliza/buscar/nombre"})
public class PolizaBuscarNombre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Poliza> polizas = polizaDAO.buscarNombre(buscar_texto,pagina);
            
            JSONArray jArray = new JSONArray();
            
            polizas.forEach((poliza) -> {
                 try {
                     jArray.add(poliza.getJSONObject());
