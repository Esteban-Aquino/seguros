 ...
 * @author Esteban
 */
@WebServlet(name = "PropuestaBuscarNombre", urlPatterns = {"/propuesta/buscar/nombre"})
public class PropuestaBuscarNombre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Propuesta> propuestas = propuestaDAO.buscarNombre(buscar_texto,pagina);
            
            JSONArray jArray = new JSONArray();
            
            propuestas.forEach((propuesta) -> {
                 try {
                     jArray.add(propuesta.getJSONObject());
