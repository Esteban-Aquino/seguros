 ...
 * @author Esteban
 */
@WebServlet(name = "BienBuscarId", urlPatterns = {"/bien/buscar/id"})
public class BienBuscarId extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_bien")) {
                    ...
                    Bien bien = bienDAO.buscarId(Integer.parseInt(request.getParameter("id_bien")));
                    out.print(bien.getJSONObject());
                    out.flush();
                }
