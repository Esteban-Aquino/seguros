 ...
 * @author Esteban
 */
@WebServlet(name = "AseguradoraEliminar", urlPatterns = {"/aseguradora/eliminar"})
public class AseguradoraEliminar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_aseguradora")) {
                    ...
                    correcto = aseguradoraDAO.eliminar(Integer.parseInt(request.getParameter("id_aseguradora")));
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
