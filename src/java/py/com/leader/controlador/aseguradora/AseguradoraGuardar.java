...
import py.com.leader.controlador.aseguradora.*;
 ...
 * @author Esteban
 */
@WebServlet(name = "AseguradoraGuardar", urlPatterns = {"/aseguradora/guardar"})
public class AseguradoraGuardar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            if (usuario == null) {
                ...
                if ("0".equals(request.getParameter("id_persona"))) {
                    ...
                    aseguradora.setId_aseguradora(Integer.parseInt(request.getParameter("id_aseguradora")));
                    aseguradora.setNombre_aseguradora(request.getParameter("nombre_persona"));
                    ...
                    aseguradora.setPersona(persona);
                    AseguradoraDAO aseguradoraDAO = new AseguradoraDAO();
                    correcto = aseguradoraDAO.guardar(aseguradora, new Usuario());
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
