 ...
 * @author Esteban
 */
@WebServlet(name = "SubmenuEliminar", urlPatterns = {"/submenu/eliminar"})
public class SubmenuEliminar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_submenu")) {
                    ...
                    correcto = submenuDAO.eliminar(Integer.parseInt(request.getParameter("id_submenu")));
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
