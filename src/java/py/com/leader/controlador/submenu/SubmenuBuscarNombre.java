 ...
 * @author Esteban
 */
@WebServlet(name = "SubmenuBuscarNombre", urlPatterns = {"/submenu/buscar/nombre"})
public class SubmenuBuscarNombre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Submenu> submenus = submenuDAO.buscarNombre(buscar_texto,pagina);
            
            JSONArray jArray = new JSONArray();
            
            submenus.forEach((submenu) -> {
                jArray.add(submenu.getJSONObject());
            });    
