 ...
 * @author Esteban
 */
@WebServlet(name = "UsuarioBuscarId", urlPatterns = {"/usuario/buscar/id"})
public class UsuarioBuscarId extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("id_usuario")) {
                    ...
                    Usuario usuario = usuarioDAO.buscarId(Integer.parseInt(request.getParameter("id_usuario")));
                    out.print(usuario.getJSONObject());
                    out.flush();
                }
