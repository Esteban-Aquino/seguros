 ...
 * @author Esteban
 */
@WebServlet(name = "RolAgregar", urlPatterns = {"/rol/agregar"})
public class RolAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                if (!request.getParameterMap().containsKey("nombre_rol")) {
                    ...
                    correcto = rolDAO.agregar(rol,usuario);
                    obj.put("correcto", correcto);
                    out.print(obj);
                    out.flush();
                }
